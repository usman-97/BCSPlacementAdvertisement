...
{
    if (!empty($_POST['description']) && !empty($_POST['benefits']) && !empty($_POST['salary']) &&
        !empty($_POST['salaryPaid']) && !empty($_POST['startDate']) && !empty($_POST['endDate']))
    {
        $placement->createPlacement($_POST['description'], $_POST['benefits'], $_POST['salary'], $_POST['salaryPaid'], $_POST['startDate'], $_POST['endDate']);
